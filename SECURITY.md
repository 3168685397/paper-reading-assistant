...
Use GitHub private vulnerability reporting: open the repository's **Security** tab and select **Report a vulnerability**. If private reporting is unavailable, use a private contact method listed on the repository owner's GitHub profile.
